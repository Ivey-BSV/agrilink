...
export default function RepositoryFilesPage() {
  return (
    <ResourceFolderLibrary
      ...
      description="Browse repository folders — each folder has a photo gallery and a document list for shared reference materials."
      memberDescription="Open a folder to store guides, PDFs, and reference images. The gallery highlights pictures; documents sit in the list below."
